...
function Hero() {
	return (
		<section className="relative bg-[url(/justice.jpg)] bg-cover bg-center bg-no-repeat">
			<div
			...
			<div className="relative mx-auto max-w-screen-xl px-4 py-32 sm:px-6 lg:flex lg:h-screen lg:items-center lg:px-8">
				<div className="max-w-xl text-center sm:text-start">
					...
					<div className="mt-8 flex flex-wrap text-center">
						<Link
							href="/contact"
							className="block w-full rounded border border-neutral-900 dark:border-neutral-100 bg-neutral-900 dark:bg-neutral-100  px-5 py-2 text-sm font-medium text-neutral-200 dark:text-neutral-900 hover:bg-transparent hover:text-neutral-900 dark:hover:bg-transparent dark:hover:text-neutral-100 focus:outline-none focus:ring active:text-neutral-50 transition duration-300 sm:w-auto">
							Contacto
						</Link>
					</div>
				</div>
