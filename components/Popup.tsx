...
function Popup({ showModal, handleModal, status }: Props) {
	return (
		<div id="modal" className={showModal ? "block" : "hidden"}>
			<div className="absolute w-screen h-screen bg-neutral-900/50 backdrop-blur-sm z-30"></div>
			<div className="fixed z-50 w-full flex content-center justify-center">
				<div
					role="alert"
					className="fixed top-10 rounded-xl border border-neutral-100 bg-neutral-100 p-4 shadow-xl dark:border-neutral-800 dark:bg-neutral-900">
